...
const Toast = ({ message, type = "success" }) => (
  <div className={`fixed top-4 right-4 px-6 py-4 rounded-xl shadow-2xl z-50 animate-slide-in ${
    ...
    <div className="bg-white rounded-2xl shadow-xl border-2 border-gray-200 overflow-hidden hover:shadow-2xl hover:scale-[1.02] transition-all">
      ...
      <a href={post.aiOutput} target="_blank" rel="noopener noreferrer">
        <div className="relative group">
          ...
          />
          <div className={`absolute top-4 right-4 px-4 py-2 rounded-full text-xs font-black shadow-xl backdrop-blur-sm ${
            post.status === "pending" ? "bg-yellow-500/90 text-white" :
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-4 py-3 rounded-xl font-semibold hover:shadow-lg transition-all"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-600 text-white px-4 py-3 rounded-xl font-semibold hover:shadow-lg transition-all"
                >
